...
class Anexo5H implements AnexoInterface
{
    ...
    {
        return 'Anexo 5H - Requerimento CHA';
    }
    public function getTemplatePath(): string
    {
        return storage_path('app/public/templates/Anexo5H-N211.pdf');
    }
    public function getFormSchema(): array
    {
        return [

            \Filament\Forms\Components\DatePicker::make('data_emissao')
            ...
            CheckboxList::make('servicos')->columns(2)->required()->options([
                '1' => '1 - Concessão por Equivalência',
                '2' => '2 - Emissão / Renovação',
                '3' => '3 - Renovação com Agregação',
                '4' => '4 - Cadastramento Marina',
                '7' => '7 - Credenciamento Escola',
                '8' => '8 - Credenciamento Escoteiro',
                '9' => '9 - Credenciamento Veleiro',
                '10a' => '10A - Renovação Escola',
                '11' => '11 - Descredenciamento',
                '12' => '12 - Revisão de Prova'
            ]),
    ...
    public function getDados($record, array $input): array
    {
        ...
        $dataEmissao = !empty($input['data_emissao']) ? Carbon::parse($input['data_emissao']) : null;
        ...
        $dados = [
            ...
            'data' => $dataEmissao ? $dataEmissao->format('d/m/Y') : '',
        ];
        ...
        foreach ($servicos as $servico) {
            ...
            if (in_array($servico, ['10a', '10b', '10c'])) {
                $dados['servico10'] = 'Sim';
                $dados['servico10_' . strtolower(substr($servico, 2))] = 'Sim';
            }
        }
