...
class Anexo5D implements AnexoInterface
{
    ...
    {
        return 'Anexo 5D - Declaração de Extravio/Roubo CHA';
    }
    public function getTemplatePath(): string
    {
        return storage_path('app/public/templates/Anexo5D-N211.pdf');
    }
    ...
    public function getDados($record, array $input): array
    {
        ...
        $dados = [
            ...
            'cidade' => mb_strtoupper(($cliente->cidade ?? '') . '/' . ($cliente->uf ?? '')),
            'cep' => $cliente->cep ?? '',
            'cha' => $cliente->cha_numero ?? '',
