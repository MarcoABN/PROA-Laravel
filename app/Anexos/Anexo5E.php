...
class Anexo5E implements AnexoInterface
{
    ...
    {
        return 'Anexo 5E - Atestado Arrais';
    }
    public function getTemplatePath(): string
    {
        return storage_path('app/public/templates/Anexo5E-N211.pdf');
    }
    public function getFormSchema(): array
    {
        return [
            Section::make('Dados do Treinamento')->schema([
                Grid::make(2)->schema([
                    DatePicker::make('data_aula')
                        ->nullable()
                        ->helperText('Deixe em branco para preencher à caneta.'),
                    TextInput::make('carga_horaria')->default('06:00')->required()
                ]),
            ]),
    ...
    public function getDados($record, array $input): array
    {
        ...
        return [
            ...
            'localdata' => ($c->cidade ?? '') . ', ' . ($dataAula ? $dataAula->translatedFormat('d \d\e F \d\e Y') : ''),
        ];
    }
}